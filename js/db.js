...
function populateDB(tx) {
    ...
    tx.executeSql("CREATE TABLE IF NOT EXISTS `inventions` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `name`, `year`, `inventorId` INTEGER, `imageName`, `imageOffline`, `imageLink`)");
